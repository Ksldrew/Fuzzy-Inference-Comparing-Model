...
class TSKModule(nn.Module):
    ...
    def forward(self, x):
        # Use the device of the input tensor to avoid CPU/GPU mismatch
...
def main():
    ...
    train_path = os.path.join(base_dir, "C:/Users/asus/Desktop/FYP Improvement/FYP2/Edited_Dataset/train.csv")
    val_path   = os.path.join(base_dir, "C:/Users/asus/Desktop/FYP Improvement/FYP2/Edited_Dataset/val.csv")
    test_path  = os.path.join(base_dir, "C:/Users/asus/Desktop/FYP Improvement/FYP2/Edited_Dataset/test.csv")
    # -----------------------------------
    ...
    output_dir = os.path.join(root_out_dir, f"tskfis_{run_id}")
